...
n formptomain(FormTitle,outss,donate,paycheck,classlist) {
  ...
  */
  ...
  var addkids = form.addPageBreakItem().setTitle("Add the rest of your Smith Family");
 ...
 var Payment = form.addPageBreakItem().setTitle("Add the rest of your Smith Family");
  //Paying method
